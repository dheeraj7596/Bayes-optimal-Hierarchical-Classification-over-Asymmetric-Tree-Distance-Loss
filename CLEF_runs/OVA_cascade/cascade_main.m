...
for root_node_index=root_node_index_set
    ...
    for pivot_index=1:length(curr_root_descendants)
        ...
        for c_index=1:length(C_vals)
            ...
            SVM_train_command=['../liblinear_train -s 3 -B 1 -e 0.01 -c ' num2str(C_value,'%5.0e') ' ' new_name_trainfile ' ' modelfile_name];
            ...
            SVM_predict_command2=['../liblinear_predict ' new_name_testfile ' ' modelfile_name ' ' outputfile2_name];
            ...
            for i=1:num_test
                ...
                values(i)=output_mult*str2double(line);
            end
